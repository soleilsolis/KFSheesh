...
<body>
	<div class="wrapper">
		...
		<form id="loginField" autocomplete="off">
			...
			<div class="field">
				<div class="submit-form" data-send="/app/user/login" data-form="loginField" style="text-align: center; padding-top: 8px">Login</div>
			</div>

			<div class="signup-link">
				Not a member? <a href="/registration">Sign up now</a> for free!
			</div>
		</form>
	</div>
	...
	<footer>
		<div class="footer stagger1">
			<a href="/" class="href">⬅ KF.Sheesh | 2021</a>
		</div>
	</footer>
